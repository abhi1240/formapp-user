...
Route::get('/test', [AuthController::class, 'test'])->name('test');
    ...
    Route::group(['middleware' => 'api_auth'], function () {
			...
			// Route::group(['middleware' => 'image_seeder'], function () {
    ...
    Route::group(['middleware' => 'approved'], function () {
      ...
      Route::get('/image-update', [HomeController::class, 'image_update'])->name('image-update');
      Route::get('/change-password', [HomeController::class, 'change_password'])->name('change-password');
      Route::post('/reset-password', [HomeController::class, 'reset_password'])->name('reset-password');
      ...
      Route::post('/image-upload', [UpdateImageController::class, 'upload_image'])->name('upload.image');
			...
			Route::post('/citys_autocomplete', [UpdateImageController::class, 'get_citys'])->name('citys');
			Route::post('/papers_autocomplete', [UpdateImageController::class, 'papers_autocomplete']);
      //dfashboard
      Route::group(['prefix' => 'user'], function () {
      Route::get('/dashboard', [UserDashboardController::class, 'dashboard'])->name('user.dashboard');
      Route::get('/explorer', [UserDashboardController::class, 'image_explorer'])->name('user.explorer');
      Route::get('/get_month', [UserDashboardController::class, 'get_month_folder'])->name('user.explorer.months');
      Route::get('/get_date', [UserDashboardController::class, 'get_date_folder'])->name('user.explorer.date');
