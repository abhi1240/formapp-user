            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                ...
                <li class="nav-item g-mx-10--lg g-mx-15--xl">
                  <a href="{{route('profile-setting')}}" class="nav-link g-py-7 g-px-0">Profile Setting</a>
                </li>
                <li class="nav-item g-mx-10--lg g-mx-15--xl ">
                  <a href="{{route('image-update')}}" class="nav-link g-py-7 g-px-0">Update Image</a>
                </li>
                <li class="nav-item  g-mx-10--lg g-mx-15--xl ">
                  <a href="{{route('change-password')}}" class="nav-link g-py-7 g-px-0">Change Password</a>
                </li>
